...
if (numof_matches == 1):
    print(str(numof_matches) + " instance of " + single_letter + " found in " + five_letter_word)
else:
    if (numof_matches >= 2):
        print(str(numof_matches) + " instances of " + single_letter + " found in " + five_letter_word)
    else:
